...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 JOptionPane.showMessageDialog(null, "Press the key that 'Simon says' to press.  Otherwise, press a different key.");
 ...
 showImage();
	...
	jakey.setVisible(true);
  	 jakey.add(getNextRandomImage()); //7. rename to the name of your frame
	...
	if (simonSays==1){
		...
		speak("Simon says press that key.");
	}
